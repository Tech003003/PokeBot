        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-[11px] font-black tracking-[0.1em] text-[#A1A1AA] uppercase border-b border-[#27272a]">
              <th className="text-left p-3">When</th><th className="text-left p-3">Product</th><th className="text-left p-3">Site</th><th className="text-left p-3">Outcome</th><th className="text-left p-3">Note</th>
            </tr>
          </thead>
          <tbody>
            {rows.length === 0 && <tr><td colSpan={5} className="p-6 text-center text-[#52525B]">No history yet.</td></tr>}
            {rows.map((r) => (
